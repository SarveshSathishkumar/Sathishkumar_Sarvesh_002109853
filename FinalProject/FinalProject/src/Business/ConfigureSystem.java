...
public class ConfigureSystem {
     ...
     Ecosystem system = Ecosystem.getInstance();
       ...
       // ngoOrganizationDirectory.createOrganization(Organization.Type.Referee);
        ...
        Enterprise volunteerEnterprise = ed.AddNewEnterprise("VolunteerEnterprise", Enterprise.EnterpriseType.Volunteers);
        ...
        volunteerOrganizationDirectory.createOrganization(Organization.Type.Volunteers);
