...
public class ConfigureSystem {
     ...
     Ecosystem system = Ecosystem.getInstance();
       ...
       // ngoOrganizationDirectory.createOrganization(Organization.Type.Coaches);
       // ngoOrganizationDirectory.createOrganization(Organization.Type.Referee);
        ...
        Enterprise supplierEnterprise = ed.AddNewEnterprise("SupplierEnterprise", Enterprise.EnterpriseType.DonationSupplier);
        ...
        supplierOrganizationDirectory.createOrganization(Organization.Type.DonationSupplier);
