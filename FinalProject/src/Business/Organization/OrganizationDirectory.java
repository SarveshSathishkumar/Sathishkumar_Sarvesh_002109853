...
public class OrganizationDirectory {
    ...
    public Organization createOrganization(Organization.Type type){
        ...
        else if (type.getValue().equals(Organization.Type.DonationSupplier.getValue())){
...
//        else if (type.getValue().equals(Organization.Type.Coaches.getValue())){
//            organization = new CoachesOrganization();
//            organizationList.add(organization);
//        }
//        else if (type.getValue().equals(Organization.Type.Referee.getValue())){
