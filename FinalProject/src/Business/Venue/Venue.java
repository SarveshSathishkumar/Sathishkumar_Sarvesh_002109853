...
public class Venue {
    ...
    HashMap<Donation, Date> matchRequests;
    ...
    public HashMap<Donation, Date> getMatchRequests() {
        return matchRequests;
    }

    public void setMatchRequests(HashMap<Donation, Date> matchRequests) {
    ...
    public void setScheduledMatches(HashMap<Donation, Date> scheduledMatches) {
    ...
    public Venue(UserAccount ua,String venueName,String venueLocation)
    {
        ...
        matchRequests = new HashMap<Donation, Date>();
