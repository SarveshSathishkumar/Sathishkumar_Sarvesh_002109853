...
public class SponsorDirectory {
    ...
    public void sponsorToTeam(String sponsorName,int budget,Company comp)
    {
    ...
    public void addTeamToSponsored(String  CompanyName,String sponsorName)
    {
        ...
        for(Sponsor s: sponsorsList)
        {
            ...
            {
                s.getSponsoredTeams().add(CompanyName);
            }
        }
    }
    
    public void offerToTeam(Sponsor sponsor,Company comp,int budget)
    {
